<?php
    ...
    if(isset($_POST['content']) && $_POST['content']!=""){
        ...
        if(isset($_COOKIE['name'])){
          ...
          $productid=$_GET['id'];
          $sql1 = "INSERT INTO comment_update(userid,date,content,fullname,productid) VALUES ($userid,now(), '$businessDesc','$fullname',$productid)";
    ...
    <section class="product">
            ...
            <div class="product-content">
                <div class="product-content-left">
                    ...
                    <div class="product-content-left-sub-img">
                        <img src="../assets/Img/<?=$product['subimage1']?>">
                        <img src="../assets/Img/<?=$product['subimage2']?>">
                        <img src="../assets/Img/<?=$product['subimage3']?>">
                    </div>
                </div>
        ...
        <section class="cmt">
            <div class="cmt-left">
                ...
                <form method="POST" >
                    <section>
                        <textarea name="content" style="width: 100%;resize: none;padding-top:10px;" rows="5" class="form-submit-comment" placeholder="Bình luận ở đây nè"></textarea>
                    </section>
            ...
            <div class="cmt-right" style="margin-top: 30px">
                <?php
                    $sql = ("SELECT * FROM user a JOIN comment_update b ON a.id=b.userid JOIN products c ON b.productid=c.id WHERE productid=".$_GET['id']);
