...
<html>
    ...
    <body>
        ...
        <form class="information" method="POST">
            ...
            <span id='Update_finish' style="font-size: 22px; color:green; padding-bottom:4px;"></span>
            <?php
                if(isset($_POST['fullname']) || isset($_POST['email']) || isset($_POST['address']) || isset($_POST['reddit']) || isset($_POST['phone'])){
                    ...
                    echo "<script>document.getElementById('Update_finish').innerHTML='Cập nhật thông tin thành công'</script>";
                }
